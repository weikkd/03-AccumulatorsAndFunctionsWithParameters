...
#            Delays by a certain amount of seconds
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            When you want the window to stay open for an indefinite amount of time so that you can view everything that has been done
#
